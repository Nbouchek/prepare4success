package com.codility.nacer.fibonacciNumbers;
 ...
 * 2, 1 and 2 rungs, and
 * 2, 2 and 1 rung.
 * The number of different ways can be very large, so it is sufficient to return the result modulo 2P, for a given
 * integer P.
 *
 * Write a function:
 *
...
public class Ladder {
    ...
    public static void main(String[] args) {
        System.out.println("Ladder:\n\t" +
                Arrays.toString(new Ladder().solution(new int[]{4, 4, 5, 5, 1}, new int[]{3, 2, 4, 3, 1})));
    }
